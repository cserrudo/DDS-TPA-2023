...
public class Miembro extends Persistente {
    ...
    public Miembro(String nombre, String apellido, String mail, Localizacion localizacion, Usuario usuario) {
        this.nombre = nombre;
    ...
    public MiembroxComunidad altaComunidad(Comunidad comunidad) {
